...
<header class="mt-2">
	<div class="grid grid-cols-1 grid-cols-2">
		<div class="p-2">
			<svg
				viewBox="0 0 117.48922 73.269998"
				version="1.1"
				id="svg19"
				width="117.48922"
				height="53.269997"
				...
				<ol class="flex overflow-hidden rounded-lg border border-gray-200 text-gray-600">
					<li class="flex items-center">
						...
						>
							...
							<span
								class="ms-1.5 font-semibold {route == '/' ? 'text-primary' : ''} hover:opacity-75"
							>
								Home
							</span>
						</a>
		...
		<div class="rounded-lg flex justify-end text-right m-2">
			<ul class="flex gap-3">
				<li>
					<a
						href="https://www.linkedin.com/company/nuvolaris-io/"
						rel="noreferrer"
						target="_blank"
				...
				<li>
					<a
						href="https://github.com/nuvolaris"
						rel="noreferrer"
						target="_blank"
						class="text-gray-700 transition hover:opacity-75"
					>
				...
				<li>
					<a
						href="https://www.youtube.com/@nuvolarisio"
						rel="noreferrer"
						target="_blank"
						class="text-gray-700 transition hover:opacity-75"
					>
	...
	<h1 class="text-4xl mt-10 md:text-7xl text-center text-primary font-extrabold">
		...
		<div class="text-primary text-xl md:text-3xl flex items-center justify-center">
			powered by
			<div class="p-3">
				<a href="https://www.nuvolaris.io/" class="flex items-center">
					Nuvolaris
					<img src={logoNuv} alt="Nuvolaris Logo" />
				</a>
			</div>
		</div>
	</h1>
